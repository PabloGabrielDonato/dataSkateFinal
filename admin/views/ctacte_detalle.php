...
<body class="">
        ...
        <div class="col-lg-12">
          <div class="modal-body">
            ...
            <div class="custom-file mb-3">
              <input type="file" class="custom-file-input recibos" name="archivo" id="subirfoto" onChange="onLoadAltaImage(event.target.files)" accept="image/jpeg,image/png,image/jpg,.pdf">
        ...
        <div class="col-lg-12">
          ...
          <div class="modal-body">
            ...
            <div class="mb-2 d-flex justify-content-center">
              <a class="badge badge-info" id="enlaceFoto">Ver Comprobante</a>
            </div>
  ...
  <script>
    ...
    var tabla = 'ctacte';
    var table;
    var institucion = localStorage.almacenarInstitucion_CtaCte; //obtiene el valor del LOCAL STORAGE
    var tipoCbte = '';
    ...
    // == Consulta el Saldo para mostrar en pantalla ==
    ...
    // == FIN Consulta el Saldo para mostrar en pantalla ==
