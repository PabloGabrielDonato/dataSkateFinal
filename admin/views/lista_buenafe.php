...
<head>
  ...
  <title>Rioplatense - Lista Buena Fe</title>
</head>
<!-- Google tag (gtag.js) -->
...
<body class="">
  ...
  <script>
    ...
    // var opcionDataTable = 'listaBuenaFe';
    ...
    var listar = function() {
      ...
      table = $("#tablaClientes").DataTable({
        ...
        columnDefs: [{
          ...
          {
            // oculta columnas
            targets: [12, 14, 15, 16, 17, 18, 19, 20],
            visible: false,
          },
        ],
        ...
        dom: '"QPBfrtilp"', // Filtro Si agregamos una P en el don aparece el buscar
        language: {
    ...
    var valorFiltro = localStorage.mostrarFiltro_listabuenaFe;
    ...
    function mostrarFiltros() {
      var mostrarFiltro_listabuenaFe = 1;
      localStorage.mostrarFiltro_listabuenaFe = mostrarFiltro_listabuenaFe;
      $('#mostrarFiltros').hide();
      $('#ocultarFiltros').show();
    ...
    function ocultarFiltros() {
      var mostrarFiltro_listabuenaFe = 0;
      localStorage.mostrarFiltro_listabuenaFe = mostrarFiltro_listabuenaFe;
      $('#mostrarFiltros').show();
      $('#ocultarFiltros').hide();
