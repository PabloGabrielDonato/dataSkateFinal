...
<head>
  ...
  <title>Rioplatense - Tabbla Divisional</title>
</head>
<!-- Google tag (gtag.js) -->
...
<body class="">
        ...
        <table id="tablaClientes" class="display responsive nowrap compact table-bordered" style="width: 60%">
          <thead class="text-center">
            <tr>
              ...
              <th class="text-center">Divisional</th>
        ...
        <div class="col-lg-12">
          ...
          <div class="form-row">
            <div class="form-group col-md-4 form-floating">
              <input name="ordendivisional" type="number" class="form-control form-control-user" id="consultarOrdenDivisional" placeholder="N° Orden" required />
              <label for="floatingInput">N° Orden</label>
            </div>

            <div class="form-group col-md-8 form-floating">
              <input name="divisional" type="text" class="form-control form-control-user" id="consultarDivisional" placeholder="Divisional" required />
              <label for="floatingInput">Divisional</label>
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="col-lg-12">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-8 form-floating">
              <input name="divisional" type="text" class="form-control form-control-user" id="altaDivicional" placeholder="Divicional" required />
              <label for="floatingInput">Divisional</label>
            </div>
          </div>
  ...
  <script>
    var id = '';
    var opcion = '';
    var tabla = 'divisional';

    // === CARGA LA TABLA CON DATOS - LECTURA TABLA GENERAL ===
    // var opcionDataTable = 'general';
    // opcion = 0;
    // url = `http://www.lepaa.com.ar/api/divisional.php?opcion=${opcion}`;
    // var url = `api/divisional.php?opcion=${opcion}`;
    ...
    function consultarUnCliente(id) {
      ...
      $(document).on("click", ".btnInfo", function() {
        ...
        parrafo.textContent = "Información Divisional"
      });
      ...
      $(document).on("click", ".btnEdit", function() {
        ...
        $('#botonAceptar').show();
        const parrafo = document.querySelector(".editar");
        parrafo.textContent = "Editar Divisional"
      });
      // consulta a base de datos según ID y opcion
      fetch(
          `../../api/divisional.php?id=${id}&opcion=${opcion}`, {
            method: 'GET',
            headers: {
        ...
        .then((datos) => {
          ...
          $("#consultarOrdenDivisional").val(datos[0].ordendivisional);
    ...
    var urlEdit = '../../api/divisional.php';
    // === FIN ACTUALIZAR DATOS ===

    // === ALTA de DATOS ===
    var urlAlta = '../../api/divisional.php';
    // === FIN Alta DATOS ===
