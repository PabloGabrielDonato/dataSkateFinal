        ...
        <table id="tablaClientes" class="display responsive nowrap compact table-bordered" style="width: 60%">
          <thead class="text-center">
            <tr>
              ...
              <th class="text-center">Edad Desde</th>
              <th class="text-center">Edad Hasta</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content ">
        <div class="modal-header">
          <h4 class="modal-title" id="exampleModalLabel">Información Categoria</h4>
          ...
          <div class="form-group row">
            ...
            <div class="form-row">
              <div class="form-group col-md-2 form-floating">
                <input name="ordencategoria" type="number" class="form-control form-control-user" id="consultarOrdenCategoria" placeholder="N° Orden" required />
                <label for="floatingInput">N° Orden</label>
              </div>

              <div class="form-group col-md-6 form-floating">
                <input name="categoria" type="text" class="form-control form-control-user" id="consultarCategoria" placeholder="Categoria" required />
                <label for="floatingInput">Categoria</label>
              </div>

              <div class="form-group col-md-2 form-floating">
                <input name="edadDesde" type="number" class="form-control form-control-user" id="consultarEdadDesde" placeholder="Edad Desde" required />
                <label for="floatingInput">Edad Desde</label>
              </div>

              <div class="form-group col-md-2 form-floating">
                <input name="edadHasta" type="number" class="form-control form-control-user" id="consultarEdadHasta" placeholder="Edad Hasta" required />
                <label for="floatingInput">Edad Hasta</label>
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="col-sm-12">
          <div class="form-group row">
            ...
            <div class="form-row">
              <div class="form-group col-md-2 form-floating">
                <input name="ordencategoria" type="number" class="form-control form-control-user" id="altaOrdenCategoria" placeholder="N° Orden" required />
                <label for="floatingInput">N° Orden</label>
              </div>

              <div class="form-group col-md-6 form-floating">
                <input name="categoria" type="text" class="form-control form-control-user" id="altaCategoria" placeholder="Categoria" required />
                <label for="floatingInput">Categoria</label>
              </div>

              <div class="form-group col-md-2 form-floating">
                <input name="edadDesde" type="number" class="form-control form-control-user" id="altaEdadDesde" placeholder="Edad Desde" required />
                <label for="floatingInput">Edad Desde</label>
              </div>

              <div class="form-group col-md-2 form-floating">
                <input name="edadHasta" type="number" class="form-control form-control-user" id="altaEdadHasta" placeholder="Edad Hasta" required />
                <label for="floatingInput">Edad Hasta</label>
              </div>
            </div>
    ...
    function consultarUnCliente(id) {
      ...
      fetch(
        ...
        .then((datos) => {
          ...
          $("#consultarOrdenCategoria").val(datos[0].ordencategoria);
          $("#consultarCategoria").val(datos[0].categoria);
          $("#consultarEdadDesde").val(datos[0].edad_desde);
          $("#consultarEdadHasta").val(datos[0].edad_hasta);

          // informa los datos de la persona que creo y modifico
