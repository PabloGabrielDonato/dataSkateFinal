...
<head>
  ...
  <title>Rioplatense - Tabla Eficiencia</title>
</head>
<!-- Google tag (gtag.js) -->
...
<body class="">
        ...
        <div class="col-lg-12">
          ...
          <div class="form-row">
            <div class="form-group col-md-4 form-floating">
              <input name="ordeneficiencia" type="number" class="form-control form-control-user" id="consultarOrdenEficiencia" placeholder="N° Orden" required />
              <label for="floatingInput">N° Orden</label>
            </div>

            <div class="form-group col-md-8 form-floating">
              <input name="eficiencia" type="text" class="form-control form-control-user" id="consultarEficiencia" placeholder="Eficiencia" required />
  ...
  <form class="modal fade" id="formAlta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="exampleModalLabel">Alta Eficiencia</h4>
        ...
        <div class="col-lg-12">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-8 form-floating">
              <input name="eficiencia" type="text" class="form-control form-control-user" id="altaEficiencia" placeholder="Eficiencia" required />
              <label for="floatingInput">Eficiencia</label>
            </div>
          </div>
  ...
  <script>
    var id = '';
    var opcion = '';
    var tabla = 'eficiencia';

    // === CARGA LA TABLA CON DATOS - LECTURA TABLA GENERAL ===
    // var opcionDataTable = 'general';
    // opcion = 0;
    // url = `http://www.lepaa.com.ar/api/eficiencia.php?opcion=${opcion}`;
    // var url = `api/eficiencia.php?opcion=${opcion}`;
    ...
    function consultarUnCliente(id) {
      ...
      $(document).on("click", ".btnInfo", function() {
        ...
        parrafo.textContent = "Información Eficiencia"
      });
      ...
      $(document).on("click", ".btnEdit", function() {
        ...
        $('#botonAceptar').show();
        const parrafo = document.querySelector(".editar");
        parrafo.textContent = "Editar Eficiencia"
      });
      // consulta a base de datos según ID y opcion
      fetch(
          `api/eficiencia.php?id=${id}&opcion=${opcion}`, {
            method: 'GET',
            headers: {
        ...
        .then((datos) => {
          ...
          $("#consultarOrdenEficiencia").val(datos[0].ordeneficiencia);
    ...
    var urlEdit = '../../api/eficiencia.php';
    // === FIN ACTUALIZAR DATOS ===

    // === ALTA de DATOS ===
    var urlAlta = '../../api/eficiencia.php';
    // === FIN Alta DATOS ===
