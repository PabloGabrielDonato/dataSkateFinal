    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="col-lg-12">
          ...
          <div class="orm-group form-floating mb-3">
          ...
          <div class="orm-group form-floating mb-3">
            <input name="valor" type="text" class="form-control form-control-user" id="consultarValor" placeholder="Valor Licencia" required />
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="col-lg-12">
          ...
          <div class="orm-group form-floating mb-3">
            <input name="valor" type="text" class="form-control form-control-user" id="altaValor" placeholder="Valor Licencia" required />
            <label for="floatingInput">Valor Licencia</label>
          </div>
