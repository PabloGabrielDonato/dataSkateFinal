...
<body class="">
                ...
                <div class="accordion-body">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3 form-floating">
                      <input name="fechanacimiento" type="text" class="form-control" id="consultarFechaNacimiento" placeholder="Fecha Nacimeinto" />
                      <label for="floatingInput">Fecha Nacimiento</label>
                    </div>
                    <div class="form-group col-md-2 form-floating">
                      <input name="edad" type="text" class="form-control" id="consultarEdad" placeholder="Edad" />
                      <label for="floatingInput">Edad</label>
                    </div>
                    <div class="form-group col-md-2 form-floating">
                      <select name="sexo" class="form-control form-select" id="consultarSexo">
                        <option value=""></option>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-5 form-floating">
                      <input name="nombre" type="text" class="form-control" id="consultarFirstName" placeholder="Nombre" />
                      <label for="floatingInput">Nombre</label>
                    </div>
                    <div class="form-group col-md-7 form-floating">
                      <input name="apellido" type="text" class="form-control" id="consultarLastName" placeholder="Apellido" />
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-8 form-floating">
                      <input name="apellido" type="text" class="form-control" id="consultarCuit" placeholder="CUIT" />
                      <label for="floatingSelect">Club</label>
                    </div>

                    <div class="form-group col-md-4 form-floating">
                      <input name="apellido" type="text" class="form-control" id="consultarLicencia" placeholder="Licencia" />
  ...
  <script>
    ...
    var valorFiltro = localStorage.users_mostrarFiltro_buenaFe;
    ...
    function mostrarFiltros() {
      var users_mostrarFiltro_buenaFe = 1;
      $('#mostrarFiltros').hide();
      $('#ocultarFiltros').show();
      $('.dtsp-panesContainer').show();
      $('.dtsb-searchBuilde').show();
      localStorage.users_mostrarFiltro_buenaFe = users_mostrarFiltro_buenaFe;
    }

    function ocultarFiltros() {
      var users_mostrarFiltro_buenaFe = 0;
      $('#mostrarFiltros').show();
      $('#ocultarFiltros').hide();
