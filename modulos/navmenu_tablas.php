        ...
        <div class="navbar-content scroll-div">
            ...
            <ul class="nav pcoded-inner-navbar">
                <?php if ($user['acceso'] == 'administrador') : ?>
                    <li class="m-b-20 nav-item pcoded-menu-caption acciones">
                        <label>ACCIONES +</label>
                    </li>
                    <div class="opciones">
                        <div class="mas" data-bs-toggle="tooltip" data-bs-placement="right" title="Agregar Nuevo">
                            <i class="fal fa-plus-square btn-alta" onclick="altaNuevo()"></i>
                        </div>
                        <div class="delete" data-bs-toggle="tooltip" data-bs-placement="right" title="Eliminar Todo">
                            <i class="fal fa-times-square" onclick="eliminarTodos()"></i>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if ($user['acceso'] == 'administrador') : ?>
                    <li class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class="nav-item pcoded-hasmenu">
                                <a href="#!" class="nav-link">
                                    <span class="pcoded-micon"><i class="fab fa-uncharted"></i></i></span>
                ...
                <?php if ($user['acceso'] != 'administrador') : ?>
                    <li class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li><a href="users_pregestion_buenafe.php">Inscrpciones Provisorias</a></li>
