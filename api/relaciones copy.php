...
switch ($opcion) {
    ...
    case 2:
        ...
        if (isset($id)) {
            ...
            if ($numeroRegistros == 0) {
                // echo json_encode('1');
                $sql = "UPDATE relacion_tablas_ddec SET id_divisional = '$divisional', id_disciplina = '$disciplina', id_eficiencia = '$eficiencia', id_categoria = '$categoria', dnimod = '$dnimod', nombremod = '$nombremod', apellidomod = '$apellidomod', cuitmod = '$cuitmod', institucionmod = '$institucionmod', fechamod = '$fechamod' WHERE relacion_tablas_ddec.id = $id;";
    ...
    case 4:
        ...
        if ($numeroRegistros == 0) {
            ...
            $sql = "INSERT INTO relacion_tablas_ddec (id_divisional, id_disciplina, id_eficiencia, id_categoria, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta) VALUES ('$divisional', '$disciplina', '$eficiencia', '$categoria', '$dnialta', '$nombrealta', '$apellidoalta', '$cuitalta', '$institucionalta', '$fechaalta')";
    ...
    WHERE
        (
            ...
            eficiencia.id = relacion_tablas_ddec.id_eficiencia
        ) AND relacion_tablas_ddec.id_divisional = $divisional AND relacion_tablas_ddec.id_disciplina=$disciplina";
    ...
    WHERE
        (
            ...
            categorias.id = relacion_tablas_ddec.id_categoria
        ) AND relacion_tablas_ddec.id_divisional=$divisional AND relacion_tablas_ddec.id_disciplina=$disciplina AND relacion_tablas_ddec.id_eficiencia=$eficiencia";
