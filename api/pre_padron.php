...
switch ($opcion) {
    ...
    case 4:
        ...
        if (!empty($_POST['dni'])) {
            ...
            if ($numeroRegistros == 0) {
                ...
                $sql = "INSERT INTO prepatinadores (dnipatinador, fechanacpatinador, nombrepatinador, apellidopatinador, sexopatinador, tipolicencia, emailpatinador, telefonopatinador, domiciliopatinador, nacionalidadpatinador, provinciapatinador, localidadpatinador, cppatinador, funcionpatinador, partidopatinador, valorLicencia, nombrepadre, dnipadre, nombremadre, dnimadre, cuit, estadocap, estadoseguro, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta) VALUES ('$dni', '$fechanacimiento', '$nombre', '$apellido', '$sexo', '$licencia', '$email', '$telefono', '$domicilio', '$nacionalidad', '$provincia', '$localidad', '$cp', '$funcion', '$partido', '$valorLicencia', '$nombrepadre', '$dnipadre', '$nombremadre', '$dnimadre', '$cuit', '$estadocap', '$estadoseguro', '$dnialta', '$nombrealta', '$apellidoalta', '$cuitalta', '$institucionalta', '$fechaalta')";
    ...
    case 5:
        ...
        // CONSULTA SI HAY DATOS CON LICENCIA VACIA
        ...
        if ($licenciaVacia == 0) {
            ...
            $sql = "INSERT INTO patinadores (dnipatinador, fechanacpatinador, nombrepatinador, apellidopatinador, sexopatinador, tipolicencia, emailpatinador, telefonopatinador, domiciliopatinador, nacionalidadpatinador, provinciapatinador, localidadpatinador, cppatinador, funcionpatinador, partidopatinador, valorLicencia, 	pagoLicencia, nombrepadre, dnipadre, nombremadre, dnimadre, cuit, estadocap, estadoseguro, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta, dnimod, nombremod, apellidomod, cuitmod, institucionmod, fechamod) SELECT dnipatinador, fechanacpatinador, nombrepatinador, apellidopatinador, sexopatinador, tipolicencia, emailpatinador, telefonopatinador, domiciliopatinador, nacionalidadpatinador, provinciapatinador, localidadpatinador, cppatinador, funcionpatinador, partidopatinador, valorLicencia, pagoLicencia, nombrepadre, dnipadre, nombremadre, dnimadre, cuit, estadocap, estadoseguro, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta, dnimod, nombremod, apellidomod, cuitmod, institucionmod, fechamod  FROM prepatinadores WHERE prepatinadores.cuit = $cuit";
            if (mysqli_query($conexion, $sql)) {
    ...
    case 7:
        // MUEVE LOS DATOS DEL PREPADRON AL PADRON por ID
        $id =  $_GET['id'];

        // CONSULTA SI HAY DATOS CON LICENCIA VACIA
        $sql = "SELECT prepatinadores.dnipatinador, prepatinadores.tipolicencia FROM prepatinadores WHERE (prepatinadores.tipolicencia='' OR prepatinadores.tipolicencia=NULL) AND prepatinadores.id=$id;";
        $result = mysqli_query($conexion, $sql);
        $licenciaVacia = mysqli_num_rows($result);
        // SI NO HAY DATO DE LICENCIAS VACIAS INICIA EL PROCESO
        if ($licenciaVacia == 0) {
            // INSERTA LOS DATOS DE PREPATINADORES EN LA TABLA PATINADORES SEGUN EL CUIT
            $sql = "INSERT INTO patinadores (dnipatinador, fechanacpatinador, nombrepatinador, apellidopatinador, sexopatinador, tipolicencia, emailpatinador, telefonopatinador, domiciliopatinador, nacionalidadpatinador, provinciapatinador, localidadpatinador, cppatinador, funcionpatinador, partidopatinador, valorLicencia, 	pagoLicencia, nombrepadre, dnipadre, nombremadre, dnimadre, cuit, estadocap, estadoseguro, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta, dnimod, nombremod, apellidomod, cuitmod, institucionmod, fechamod) SELECT dnipatinador, fechanacpatinador, nombrepatinador, apellidopatinador, sexopatinador, tipolicencia, emailpatinador, telefonopatinador, domiciliopatinador, nacionalidadpatinador, provinciapatinador, localidadpatinador, cppatinador, funcionpatinador, partidopatinador, valorLicencia, pagoLicencia, nombrepadre, dnipadre, nombremadre, dnimadre, cuit, estadocap, estadoseguro, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta, dnimod, nombremod, apellidomod, cuitmod, institucionmod, fechamod  FROM prepatinadores WHERE prepatinadores.id = $id";
            if (mysqli_query($conexion, $sql)) {
                // INSERTA LOS DATOS DE PREPATINADORES EN LA TABLA CTA CTE SEGUN EL CUIT
                $sql = "INSERT INTO ctacte (cuit, tipo_comprobante, fecha_alta, concepto, adeudado, pagado, dnipatinador, tipolicencia,dnialta, apellidoalta, nombrealta, cuitalta, institucionalta, fechaalta) SELECT cuit, 'Ticket', fechaalta, 'LICENCIAS', valorLicencia, '0', dnipatinador, tipolicencia, dnialta, apellidoalta, nombrealta, cuitalta, institucionalta, fechaalta FROM prepatinadores WHERE prepatinadores.id = $id";
                if (mysqli_query($conexion, $sql)) {
                    // BORRA LOS DATOS DE LA TABLA PATINADORES SEGUN EL CUIT
                    $sql = "DELETE FROM prepatinadores WHERE prepatinadores.id = $id";
                    if (mysqli_query($conexion, $sql)) {
            ...
            echo json_encode('El patinador/a que no tienen establecida su licecia. Por favor completar!');
        };
